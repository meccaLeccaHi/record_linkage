...
class Probabilistic(linkage_tools.Linker):
    """
    Probabilistic record-linkage model.
    Parameters
    ------------
    inputnodes : int
        Size of input layer
    ...
    ------------
    m_probs : 1d-array
        Probabilities that the field agrees given a record pair matches.
    u_probs : 1d-array
        Probabilities of chance agreement of its value states.
